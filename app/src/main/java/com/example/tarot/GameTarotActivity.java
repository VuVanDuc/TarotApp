...
public class GameTarotActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_tarot);
...
//                Toast.makeText(GameTarotActivity.this, "Bai cua ban la!", Toast.LENGTH_SHORT).show();
                if(darut==0){
...
//                      Toast.makeText(GameTarotActivity.this, "sdfsdfd", Toast.LENGTH_LONG).show();
                    }
                    trangthai1.setText("Hôm nay bạn đã rút bài.");
                    trangthai2.setText(" Hãy nhấn vào lá bài để xem lại!");
                    Intent intent = new Intent(GameTarotActivity.this, ResultCardActivity.class);
                    //gui CardID
        ...
        lichsu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(GameTarotActivity.this, HistoryActivity.class);;
                startActivity(intent);
        ...
        tarotcunghoangdao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               //chuyển sang trang hoàng đạo chọn cung muốn xem
                Intent intent = new Intent(GameTarotActivity.this,TarotActivity.class);;
                startActivity(intent);
